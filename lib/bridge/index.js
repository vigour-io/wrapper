 ...
 **/
exports.postMessage = function (pluginId, fnName, params, cb) {
  var id = messageId++
  callbackMap[id] = cb
  exports.send([id, pluginId, fnName, params])
}
window.callNative = exports.postMessage
if (!window.vigourNative) {
  window.vigourNative = {}
}
window.vigourNative.bridge = exports.postMessage
...
exports.receiveResult = function (id, result) {
  window.receiveNativeResult(id, result)
}

exports.receiveError = function (id, error) {
  window.receiveNativeError(id, error)
}
