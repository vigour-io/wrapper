...
function buildHtml (opts) {
	...
	return new Promise(function (resolve, reject) {
		var file = fs.createReadStream(opts.root + "/build.html").pipe(fs.createWriteStream(opts.buildDir + "/build.html"))	
		file.on("close",function() {
			nativeUtil.buildIndexHtml(opts.buildDir + "/build.html")
			resolve(opts)
		})	
	})
}
