...
var _readJSON = Promise.denodeify(fs.readJSON)
var _writeJSON = Promise.denodeify(fs.writeJSON)
var _mkdirp = Promise.denodeify(fs.mkdirp)
...
function configure (opts) {
  ...
  options.plugins = opts.native.plugins
  return options
}
