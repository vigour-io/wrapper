    ...
    return new Promise(function (resolve, reject) {
      try {
        ...
        try {
          ...
          // allow plugins to not build an aar
          log.warn('plugin did not build .aar file! ' + pluginOpts.name)
          pluginOpts.skipInstall = true
        }
        resolve(pluginOpts)
      } catch(e) {
        reject(e)
  ...
  if (!opts.plugins) {
    ...
    return opts.plugins.reduce(function (prev, plugin) {
      return prev.then(function () {
        ...
        pluginPath = path.join(opts.root, 'node_modules', plugin.name)
