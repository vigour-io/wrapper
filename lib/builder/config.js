...
config.items = {
  ...
  'vigour.native.platforms.android.keystoreFile': {
    def: null,
    cli: '--android-keystore-file',
    desc: 'keystore to sign release build'
  },
  'vigour.native.platforms.android.keystorePassword': {
    def: null,
    env: 'KEYSTORE_PASS',
    cli: '--android-keystore-password',
    desc: 'password for the keystore to sign release build'
  },
  'vigour.native.platforms.android.keystoreAlias': {
    def: null,
    cli: '--android-keystore-alias',
    desc: 'alias for the key to sign release build'
  },
  'vigour.native.platforms.android.keystoreKeyPassword': {
    def: null,
    cli: '--android-keystore-key-password',
    desc: 'password for the key to sign release build'
  }
}
