...
/**
 * Updates the template to use the project's assets such as app icons, launch
 * images, etc.
 *
 * @memberof IosBuilder
 * @instance
 ...
 */
module.exports = exports = function (remote, remotePort) {
  if (this.builds) {
    var self = this
    ...
    if (remote) {
      imgOpts.remote = remote
    }
    if (remotePort) {
      imgOpts.remotePort = remotePort
    }
    ...
    log.info('- skipping creating images -')
