    ...
    return new Promise(function (resolve, reject) {
      ...
      pluginInfoList.forEach(function (info) {
        ...
        if (info.android.strings) {
          strings.concat(info.android.strings)
        }
      })
      ...
      // get the Manifest and inject metadata
      // TODO implement this
      log.info('  inject into AndroidManifest')
      metadata.forEach(function (s) {
        log.info(s)
      })

      // get the Manifest and inject activities
      // TODO implement this
      log.info('  inject into AndroidManifest')
      activities.forEach(function (s) {
        log.info(s)
      })
